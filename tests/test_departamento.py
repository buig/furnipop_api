...
object_original = {'nombre':'Accounting','codigo':'AC'}
object_update = {'nombre':'Depot','codigo':'DP'}
object_ref="Accounting"
object_update_ref = "Depot"
multiple_route = "/departamentos"
single_route = "/departamento/{pk}"
...
class DepartamentoTestCase(TestCase):
    ...
    def is_object_created(self):
        color = Departamento.objects.get(nombre=object_ref)
