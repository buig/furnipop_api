...
object_original = {"nombre": "Confirmed"}
object_update = {"nombre": "Ongoing preparation"}
object_ref="Confirmed"
object_update_ref = "Ongoing preparation"
multiple_route = "/estados-pedido"
single_route = "/estado-pedido/{pk}"


class EstadoPedidoTestCase(TestCase):
    ...
    def is_object_created(self):
        color = EstadoPedido.objects.get(nombre=object_ref)
